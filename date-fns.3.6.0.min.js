...
var iX = function (N, V) {
  ...
  P = function (N, V, w) {
    return (
      (V = UK(V)), ej(N, aX() ? Reflect.construct(V, w || [], UK(N).constructor) : V.apply(N, w))
    )
  },
  ej = function (N, V) {
  ...
  ; (function () {
    ...
    function _K(G, X) {
      var K = q(G),
        ...
        U = M(G, 0)
      return (
        U.setFullYear(X, 0, 4), U.setHours(0, 0, 0, 0), (K = xG(U)), K.setDate(K.getDate() + B), K
      )
    }
    function lK(G, X) {
      return _K(G, HG(G) + X)
    ...
    function xX(G, X, K) {
      ...
      } else if (I < bG * 2) return (z = Math.round(I / bG)), j.formatDistance('aboutXMonths', z, H)
      if (((z = lG(A, x)), z < 12)) {
    ...
    function GU(G, X, K) {
      ...
      return new Intl.DateTimeFormat(
        (B = K) === null || B === void 0 ? void 0 : B.locale,
        U
      ).format(q(G))
    }
    var KU = function G(X) {
    ...
    var HU = 10,
      ...
      AU = (function (G) {
        ...
        function X() {
          ...
          return (
            (K = P(this, X, [].concat(U))), F(C(K), 'priority', HU), F(C(K), 'subPriority', -1), K
          )
        }
        return (
          $(X, [
            ...
            },
            {
              ...
              value: function K(B, U, Z, j) {
                ...
                if (Z.isTwoDigitYear) {
                  var Q = YX(Z.year, J)
                  return (
                    B.setFullYear(Q, 0, j.firstWeekContainsDate), B.setHours(0, 0, 0, 0), f(B, j)
                  )
                }
                var H = !('era' in U) || U.era === 1 ? Z.year : 1 - Z.year
                return B.setFullYear(H, 0, j.firstWeekContainsDate), B.setHours(0, 0, 0, 0), f(B, j)
              },
            },
          ]),
          X
    ...
    function $X(G, X, K, B) {
      ...
      try {
        var oj = function c() {
          ...
          if (!(B !== null && B !== void 0 && B.useAdditionalDayOfYearTokens) && QX(O))
            MK(O, X, G)
          var t = O[0],
            BK = LX[t]
          if (BK) {
