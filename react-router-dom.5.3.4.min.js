!(function (t, n) {
        ...
        ? o.pathname
          ...
          (o.pathname = (function (t, n) {
            var e = 1 < arguments.length && void 0 !== n ? n : '',
              ...
              a = e && d(e),
              c = i || a
            if ((t && d(t) ? (o = r) : r.length && (o.pop(), (o = o.concat(r))), !o.length))
              return '/'
            var u = void 0
            if (o.length) {
              var s = o[o.length - 1]
  ...
  function w(t) {
    ...
    function E(t) {
      1 === (C += t) && 1 === t
        ? (window.addEventListener(N, y), n && window.addEventListener(H, m))
        : 0 === C && (window.removeEventListener(N, y), n && window.removeEventListener(H, m))
    }
    var S = !1
    var R = {
      length: c.length,
        ...
        d.confirmTransitionTo(a, 'PUSH', f, function (t) {
          if (t) {
            var n = P(a),
              ...
              r = a.state
            if (u)
              if ((c.pushState({ key: e, state: r }, null, n), s)) window.location.href = n
              else {
        ...
        d.confirmTransitionTo(a, i, f, function (t) {
          if (t) {
            var n = P(a),
              ...
              r = a.state
            if (u)
              if ((c.replaceState({ key: e, state: r }, null, n), s)) window.location.replace(n)
              else {
                var o = x.indexOf(R.location.key)
        ...
        p.confirmTransitionTo(i, 'PUSH', a, function (t) {
          if (t) {
            ...
            if (D() !== e) {
              ...
              o.push(n), (b = o), h({ action: 'PUSH', location: i })
            } else h()
          }
        })
      },
  ...
  function Y(f) {
    ...
    return function (t, n) {
      for (
        var e = '', r = t || {}, o = (n || {}).pretty ? G : encodeURIComponent, i = 0;
        i < f.length;
        i++
      ) {
        var a = f[i]
        if ('string' != typeof a) {
          ...
          if (O(u)) {
            ...
            if (
              ...
              throw new TypeError(
                'Expected "' + a.name + '" to match "' + a.pattern + '", but received "' + c + '"'
              )
            e += a.prefix + c
          }
        } else e += a
  ...
  var gt =
    ...
    function (e, i) {
        ...
        o = (function (o) {
          function t() {
            for (var t, n = arguments.length, e = new Array(n), r = 0; r < n; r++)
              e[r] = arguments[r]
            return (
              ((t = o.call.apply(o, [this].concat(e)) || this).emitter = (function (e) {
                var r = []
                return {
                  on: function (t) {
                    r.push(t)
      ...
      var a = (function (o) {
        function t() {
          for (var e, t = arguments.length, n = new Array(t), r = 0; r < t; r++)
            n[r] = arguments[r]
          return (
            ((e = o.call.apply(o, [this].concat(n)) || this).observedBits = void 0),
      ...
      return (a.contextTypes = (((n = {})[r] = h.object), n)), { Provider: o, Consumer: a }
    },
    ...
    Pt = (function (o) {
      function t() {
        ...
        return (
          ((t = o.call.apply(o, [this].concat(e)) || this).history = (function (t) {
            void 0 === t && (t = {})
            var n = t,
      ...
      return (
        ...
        (t.prototype.render = function () {
          return C.createElement(xt, { history: this.history, children: this.props.children })
        }),
        t
      )
    })(C.Component),
  ...
  var Ft = (function (o) {
    function t() {
      ...
      return (
        ((n = o.call.apply(o, [this].concat(e)) || this).handlePush = function (t) {
        ...
        var e = this.props,
          ...
          ; (a.action = n),
            (a.location = (function (t, n) {
              return t ? T({}, n, { pathname: _t(t) + n.pathname }) : n
            })(o, L(t))),
            (a.url = Lt(a.location))
      }),
      (n.render = function () {
          ...
          u = {
            ...
            location: (function (t, n) {
              ...
              return 0 !== n.pathname.indexOf(e)
                ? n
                : T({}, n, { pathname: n.pathname.substr(e.length) })
            })(e, L(a)),
        ...
        return C.createElement(xt, T({}, c, { history: u, staticContext: o }))
      }),
      t
    )
  })(C.Component),
            ...
            return (
              C.Children.forEach(t.props.children, function (t) {
                if (null == o && C.isValidElement(t)) {
                  ...
                  o = n ? Mt(i.pathname, T({}, t.props, { path: n })) : e.match
                }
              }),
  ...
  var Qt = Yt(function (t, f) {
    ...
    return C.createElement(bt.Consumer, null, function (t) {
      ...
      var n = m || t.location,
        ...
        r = e.pathname,
        o = r && r.replace(/([.+*?=^!:${}()[\]|/\\])/g, '\\$1'),
        i = o ? Mt(n.pathname, { path: o, exact: v, sensitive: g, strict: w }) : null,
        a = !!(y ? y(i, n) : i),
      ...
      a &&
        ((c = (function () {
          ...
          (u = T({}, u, h)))
      var s = T({ 'aria-current': (a && l) || null, className: c, style: u, to: e }, O)
    ...
    ; (t.BrowserRouter = Vt),
      ...
      (t.withRouter = function (r) {
        function t(t) {
          ...
          return C.createElement(bt.Consumer, null, function (t) {
            return t || k(!1), C.createElement(r, T({}, e, t, { ref: n }))
          })
        }
