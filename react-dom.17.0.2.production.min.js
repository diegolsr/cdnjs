  ...
  'use strict'
    ; (function (M, ha) {
      ...
      function qg(a, b, c, d) {
        ...
        b = Tc(b, 'onChange')
        0 < b.length &&
          ((c = new le('onChange', 'change', null, c, d)), a.push({ event: c, listeners: b }))
      }
      function Vi(a) {
        rg(a, 0)
      }
              ...
              if (!f)
                if (((a = hd(g)), null !== a)) {
                  if (
                    ...
                    return (
                      (b = b.lastEffect = d.lastEffect), null !== b && (b.nextEffect = null), null
                    )
                } else
      ...
      function tf(a, b, c) {
        var d =
          (null != c && null != c.hydrationOptions && c.hydrationOptions.mutableSources) || null
      ...
      var Pj = function (a, b, c) {
        ...
        switch (b.tag) {
          ...
          case 14:
            return (
              (e = b.type), (f = ea(e, b.pendingProps)), (f = ea(e.type, f)), zh(a, b, e, f, d, c)
            )
          case 15:
